...
export const environment = {
  ...
  webinServiceUrl: 'http://localhost:8110/ena/submit/drop-box/submit/',
  ...
  webinReportServiceUrl: 'http://localhost:8221/ena/submit/report',
  //webinXmlReportServiceUrl: 'http://ves-ebi-5b:8110/ena/submit/drop-box',
  webinXmlReportServiceUrl: 'http://localhost:8110/ena/submit/drop-box',
